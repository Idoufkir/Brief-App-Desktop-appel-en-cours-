...
var BtnAppel = document.getElementById("callit");
var btnAddContact = document.getElementById('addContact');
var phoneNumber = document.getElementById("numbers");

var dirCall = path.join(__dirname, "./Data/Recents.txt");
var dirContact = path.join(__dirname, "./Data/Contacts.txt");
...
window.addEventListener('load', () => {
    fs.readFileSync(dirCall, "utf8").split(/\n/).forEach(function (data) {
        ...
        var GlobalDiv = document.getElementById('historyCall');
...
fs.readFileSync(dirContact, "utf8").split(/\n/).forEach(function (data) {
    ...
    var GlobalDiv = document.getElementById('peoplesId');
    var div = document.createElement('div');
    div.className = 'tabContent';
    var ul = document.createElement('ul');
    var li = document.createElement('li');
